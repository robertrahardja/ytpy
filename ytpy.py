...
def parse_vtt_file(vtt_file):
    """
    Parse VTT subtitle file and extract clean text without timestamps
    """
    try:
        ...
        for line in lines:
            ...
            # Clean up VTT timestamp tags like <00:00:00.560><c> text</c>
            # Remove all timestamp and markup tags
        ...
        # Join all lines with spaces and clean up extra whitespace
